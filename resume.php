    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <p>Teach student programming techniques and how to write Python while also thinking of new ways to solve problems that assists in the student's learning.</p>
          <hr>
        </div>
      </div>
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>University of Northern Iowa</b></h5>
          <h6 class="w3-text-blue"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2015-2019</h6>
          <p>BA Computer Science</p>
          <p>Classes of Interest: System Security, Databases, Networking, Project Management, Operating Systems</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Union Highschool</b></h5>
          <h6 class="w3-text-blue"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2011 - 2015</h6>
      ...
      <div class="w3-container w3-card w3-white">
        ...
        <div class="w3-container">
          ...
          <p> This site has been my outlet for learning PHP, HTML, JS, and CSS while also doubling as a host for my portfolio and resume. A majority of the content is found on the index page and utilizes the Materialize CSS framework. Github repo found <a href="https://github.com/michohl/personalWebsite">HERE</a></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Server Hosting</b></h5>
          ...
          <p> Starting in 2017 I started self hosting all of my services such as my website and file hosting. I've been doing this on a tower running multiple virtual machines comprised of both Windows servers and Linux servers.</p>
          <hr>
        </div>      
      </div>
    <!-- End Right Column -->
